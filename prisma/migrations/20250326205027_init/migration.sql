-- CreateEnum
CREATE TYPE "EnumOrderStatus" AS ENUM ('AWAITING_COMFIRMARION', 'COMFIRMARION', 'MAKING_AN_ORDER', 'ORDER_IS_READY', 'DELIVERED', 'ORDER_COMPLETED');
...
CREATE TABLE "User" (
    ...
    "avatar_path" TEXT NOT NULL DEFAULT '/defaultImg.jpg',
...
CREATE TABLE "Order" (
    ...
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    "status" "EnumOrderStatus" NOT NULL DEFAULT 'AWAITING_COMFIRMARION',
